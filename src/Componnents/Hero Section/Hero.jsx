        ...
        <>
            <header>
                ...
                <div className="flex flex-col justify-center items-center h-full text-center">
                    ...
                    <p className="z-10 text-gray-300 text-base md:text-lg lg:text-xl font-medium px-4">Find the perfect look for every occasion. Shop from our exclusive collection today!</p>
